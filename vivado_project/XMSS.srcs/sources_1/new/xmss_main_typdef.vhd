...
package xmss_main_typedef is
    ...
    constant zero_hash_xmss_child_input : absorb_message_input_type := ('0', 0,(others => '0'));
    ...
    constant zero_wots_xmss_child_input : wots_input_type_small := ('0', (others => '0'), (others => '0'), (others => '0'), (others => '0'));
    ...
    constant zero_thash_xmss_child_input : xmss_thash_h_input_type_small := ('0', (others => '0'),(others => '0'),(others => '0'),(others => '0'), (others => '0'), (others => '0'));
    ...
    constant zero_l_tree_xmss_child_input : xmss_l_tree_input_type_small := ('0', (others => '0'));
    ...
    constant zero_treehash_xmss_child_input : xmss_treehash_input_type_small := ('0', 0, '0');
    ...
    constant zero_hash_message_xmss_child_input : hash_message_input_type_small := ('0',(others => '0'), 0);
